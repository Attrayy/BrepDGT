...
from brepdgt.diffusion.utils import default, exists
...
class Unet1D(Module):
    ...
    def __init__(
        ...
        assert self_condition == False
        assert learned_variance == False
        ...
        self.init_conv = nn.Conv1d(input_dim, channels, 7, padding=3)
        ...
        self.final_res_block = resnet_block(channels * 2, channels)
